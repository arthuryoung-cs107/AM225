fig1 = figure('Name', 'alt C2 cubic solution', 'Renderer', 'painters', 'Position', fig_pos(1, :));
xlabel('x')
ylabel('u_{fea}')
hold on
...
for N=N_min:delta:N_max
  ...
  prob3_sol = aysml_read(['../dat_dir/prob3_altcube_C2_N', num2str(N),'_Ntest', num2str(N_test)]);
  ...
  ylabel('u_{fea}')
  hold on
  plot(prob3_sol(:, 1), prob3_sol(:, 2), ' o', 'Color', red5, 'LineWidth', 1.5, 'DisplayName', 'C2 FEA solution')
