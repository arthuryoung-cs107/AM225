...
void Ritz_Galerk::mul_A(double *in,double *out) {
    int i,j,k;
...
void Ritz_Galerk::print(FILE *fp) {
    double xx=1+h;
    fprintf(fp,"1 0 0 %g\n",*f);
...
void Ritz_Galerk::print(const char* filename) {
 ...
 * integral.
 * \return The L2 norm. */
double Ritz_Galerk::l2_norm_mms() {
    double l2=0.,xx=1.;
